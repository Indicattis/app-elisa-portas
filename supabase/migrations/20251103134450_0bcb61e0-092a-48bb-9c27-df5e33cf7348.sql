-- Atualizar função para resetar pedido e excluir instalações cadastradas também
...
BEGIN
  ...
  -- 3. Excluir instalações cadastradas relacionadas ao pedido
  ...
  -- 6. Atualizar o pedido para etapa "aberto"
