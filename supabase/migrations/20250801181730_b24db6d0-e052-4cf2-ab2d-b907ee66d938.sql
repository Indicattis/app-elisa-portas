-- Primeiro, vamos verificar e remover o enum conflitante se existir
DO $$
BEGIN
    -- Tentar dropar o enum app_role se já existir
...
-- Criar tabela de roles do usuário usando o enum existente user_role
...
-- Criar tabela de permissões por role usando o enum existente user_role
