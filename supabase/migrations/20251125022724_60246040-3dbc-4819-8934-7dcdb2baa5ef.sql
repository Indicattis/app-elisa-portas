-- Criar função para concluir carregamento e avançar pedido
...
BEGIN
  ...
  IF v_etapa_atual != 'aguardando_coleta' THEN
    RAISE EXCEPTION 'Pedido deve estar em "Aguardando Coleta" para concluir carregamento. Etapa atual: %', v_etapa_atual;
  END IF;
