-- Função RPC unificada para retroceder pedidos
-- Suporta 3 destinos: aberto, em_producao, aguardando_pintura
...
BEGIN
  ...
  -- Exclui instalacao, recria/reseta pintura
  -- =============================================
  ELSIF p_etapa_destino = 'aguardando_pintura' THEN
    ...
    -- Verificar se existe ordem de pintura
