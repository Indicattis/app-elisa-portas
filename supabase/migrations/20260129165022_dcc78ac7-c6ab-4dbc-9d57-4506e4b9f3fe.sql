CREATE OR REPLACE FUNCTION public.retroceder_pedido_unificado(p_pedido_id uuid, p_etapa_destino text, p_motivo text, p_ordens_config jsonb DEFAULT '[]'::jsonb, p_user_id uuid DEFAULT NULL::uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
