...
BEGIN
  ...
  -- Create new stage entry (WITHOUT em_backlog and motivo_backlog - they don't exist in this table)
  INSERT INTO pedidos_etapas (pedido_id, etapa, data_entrada)
  VALUES (p_pedido_id, p_etapa_destino, NOW());

  -- Update pedidos_producao with backlog info (em_backlog and motivo_backlog ARE in this table)
