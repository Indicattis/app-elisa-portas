-- Dropar e recriar a função com prioridade
...
BEGIN
  ...
  SELECT 
    ...
    COALESCE(pp.prioridade, 999) as prioridade,
    -- Soldagem
  ...
  WHERE pp.etapa_atual IN ('producao', 'qualidade', 'pintura', 'carregamento')
  ...
  ORDER BY COALESCE(pp.prioridade, 999) ASC, pp.created_at ASC;
END;
$$;