-- Corrigir função get_portas_por_etapa para usar tabelas corretas
...
BEGIN
  ...
  SELECT
    COALESCE((
      SELECT SUM(op.metros_lineares)
      FROM ordens_perfilagem op
...
-- Corrigir função get_desempenho_etapas para usar tabelas corretas
