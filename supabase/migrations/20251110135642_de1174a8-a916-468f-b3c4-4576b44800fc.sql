-- Atualizar função retroceder_pedido_para_etapa para tratar backlog em aguardando_pintura
...
BEGIN
  ...
  -- ========================================
  -- CASO 3: Retroceder para "aguardando_pintura"
  -- ========================================
  ELSIF p_etapa_destino = 'aguardando_pintura' THEN
    RAISE LOG '[retroceder] CASO 3: MANTER ordens de produção base CONCLUÍDAS, RESETAR apenas pintura';
    
    -- MANTER ordens de produção base (solda, perfiladeira, separação) como estão
    ...
    -- MANTER ordem de qualidade como está
    UPDATE ordens_qualidade 
    SET em_backlog = true, 
        prioridade = v_max_prioridade + 1000
    WHERE pedido_id = p_pedido_id;
    
    -- RESETAR apenas a ordem de pintura
    ...
    -- Resetar linhas da ordem de pintura
    UPDATE linhas_ordens
    SET concluida = false, 
        concluida_em = NULL, 
        concluida_por = NULL
    ...
    -- Atualizar instalações/entregas para "em_producao"
    UPDATE instalacoes_cadastradas
    SET status = 'em_producao', 
        instalacao_concluida = false,
        instalacao_concluida_em = NULL, 
    ...
    RAISE LOG '[retroceder] Ordens de produção base MANTIDAS, pintura RESETADA';

  -- ========================================
  -- CASO 4: Retroceder para "aguardando_coleta"
  -- ========================================
  ELSIF p_etapa_destino = 'aguardando_coleta' THEN
    RAISE LOG '[retroceder] CASO 4: Mantendo ordens CONCLUÍDAS, atualizando entrega';
  ...
  -- ========================================
  -- CASO 5: Retroceder para "aguardando_instalacao"
  -- ========================================
  ELSIF p_etapa_destino = 'aguardando_instalacao' THEN
    RAISE LOG '[retroceder] CASO 5: Mantendo ordens CONCLUÍDAS, atualizando instalação';
  ...
  -- ========================================
  -- CASO 6: Outras etapas (inspecao_qualidade)
  -- ========================================
  ELSE
    RAISE LOG '[retroceder] CASO 6: Resetando parcial para etapa %', p_etapa_destino;
