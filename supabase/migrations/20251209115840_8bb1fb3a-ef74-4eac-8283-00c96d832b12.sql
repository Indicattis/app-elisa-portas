-- Remover triggers obsoletos que referenciam tabela 'entregas' inexistente
...
-- Remover funções obsoletas que referenciam tabela 'entregas'
DROP FUNCTION IF EXISTS sync_entrega_status_from_pedido();
DROP FUNCTION IF EXISTS excluir_entrega_ao_retroceder_pedido();

-- Atualizar função excluir_pedido_em_aberto para remover referência à tabela 'entregas'
