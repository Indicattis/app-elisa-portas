-- Corrigir função criar_ordens_producao_automaticas para usar setor_responsavel_producao
...
-- Limpar dados incorretos do pedido de teste e recriar
DO $$
BEGIN
  -- Deletar linhas incorretas
  DELETE FROM linhas_ordens WHERE pedido_id = '521d3633-0730-42c8-9468-fcf295989cec';
  
  -- Deletar ordens criadas incorretamente
  DELETE FROM ordens_soldagem WHERE pedido_id = '521d3633-0730-42c8-9468-fcf295989cec';
  DELETE FROM ordens_perfiladeira WHERE pedido_id = '521d3633-0730-42c8-9468-fcf295989cec';
  DELETE FROM ordens_separacao WHERE pedido_id = '521d3633-0730-42c8-9468-fcf295989cec';
  
  -- Recriar as ordens corretamente
  PERFORM criar_ordens_producao_automaticas('521d3633-0730-42c8-9468-fcf295989cec');
END $$;