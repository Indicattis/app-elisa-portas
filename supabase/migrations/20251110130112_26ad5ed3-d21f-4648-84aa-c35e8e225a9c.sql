-- Corrigir função retroceder_pedido_para_etapa removendo coluna observacoes
...
BEGIN
  ...
  ELSIF p_etapa_destino = 'em_producao' THEN
    ...
    -- Resetar TODAS as ordens para pendente E marcar historico = FALSE
    ...
    RAISE LOG '[retroceder] Ordens resetadas para PENDENTE com historico=FALSE, instalações/entregas em produção';
  ...
  -- Criar nova etapa com checkboxes padrão para a etapa de destino (SEM observacoes)
