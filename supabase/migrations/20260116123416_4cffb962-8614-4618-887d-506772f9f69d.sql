-- Fix: Correct table names in get_pedidos_com_status_ordens function
-- The previous migration used 'pedidos' instead of 'pedidos_producao' and 'produtos_venda' instead of 'produtos_vendas'
