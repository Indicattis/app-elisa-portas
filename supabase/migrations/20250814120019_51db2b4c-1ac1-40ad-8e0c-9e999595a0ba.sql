-- Corrigir a função criar_requisicao_venda para garantir que o canal de aquisição seja corretamente transferido
...
BEGIN
  ...
  -- Criar requisição de venda com o canal de aquisição do orçamento
