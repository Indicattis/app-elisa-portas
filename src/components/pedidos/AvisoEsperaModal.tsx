...
interface AvisoEsperaModalProps {
  open: boolean;
...
export function AvisoEsperaModal({
  open,
  onOpenChange,
  pedidoNumero,
  avisoAtual,
      ...
      <DialogContent className="max-w-md" onClick={(e) => e.stopPropagation()}>
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Aviso de Espera - {pedidoNumero}
          </DialogTitle>
          <DialogDescription>
            {avisoAtual
              ? "Este pedido está em espera. Você pode editar ou remover o aviso."
              : "Registre o motivo pelo qual este pedido ainda não foi preenchido. Ele será movido para a última posição."}
          </DialogDescription>
        </DialogHeader>
