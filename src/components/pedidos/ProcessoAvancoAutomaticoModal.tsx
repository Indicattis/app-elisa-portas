...
import type { Processo } from "./ProcessoAvancoModal";

interface ProcessoAvancoAutomaticoModalProps {
  open: boolean;
  processos: Processo[];
}

export function ProcessoAvancoAutomaticoModal({ open, processos }: ProcessoAvancoAutomaticoModalProps) {
  ...
  return (
    <Dialog open={open} modal>
      ...
      >
        <DialogHeader>
          <DialogTitle className="text-center">Avanço Automático de Pedido</DialogTitle>
        </DialogHeader>
        ...
        {temErro && (
          <div className="text-center text-sm text-destructive pb-2">
            Ocorreu um erro durante o avanço automático.
          </div>
        )}
      </DialogContent>
    </Dialog>
