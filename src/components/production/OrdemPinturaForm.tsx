...
interface OrdemPinturaFormProps {
  pedidoId: string;
  isOpen: boolean;
...
export default function OrdemPinturaForm({ 
  pedidoId, 
  isOpen, 
  onSave, 
  onCancel,
  maxOrdens 
}: OrdemPinturaFormProps) {
  console.log('OrdemPinturaForm rendered with maxOrdens:', maxOrdens);
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Criar Ordens de Pintura</CardTitle>
      </CardHeader>
