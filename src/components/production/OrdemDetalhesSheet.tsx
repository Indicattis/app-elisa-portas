            ...
            <div className="space-y-4">
              {tipoOrdem === 'pintura' ? (
                ...
                (() => {
                  ...
                  // Verificar se há produto_venda_id nas linhas
                  const temAgrupamentoPorPorta = linhasQuePrecisaPintura.some(l => l.produto_venda_id);
                  
                  // CASO 1: Linhas NÃO vinculadas a portas específicas
                  // Mostrar "Itens para X Portas" com dimensões no cabeçalho
                  if (!temAgrupamentoPorPorta && portasEnrolar.length > 0) {
                    const primeiraLinha = linhasQuePrecisaPintura[0];
                    const todasConcluidasPorta = linhasQuePrecisaPintura.every(l => l.concluida);
                    
                    return (
                      <div className="space-y-2 p-3 rounded-lg border bg-card">
                        {/* Cabeçalho com info de todas as portas */}
                        <div className="flex flex-col gap-2 mb-2 pb-2 border-b">
                          ...
                          {/* Dimensões de cada porta */}
                          <div className="flex flex-wrap gap-2">
                            {portasEnrolar.map((p: any, i: number) => (
                  ...
                  // CASO 2: Linhas vinculadas a portas específicas (comportamento atual)
