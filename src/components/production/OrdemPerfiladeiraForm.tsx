...
interface OrdemPerfiladeiraFormProps {
  pedidoId: string;
  isOpen: boolean;
...
export default function OrdemPerfiladeiraForm({ 
  pedidoId, 
  isOpen, 
  onSave, 
  onCancel,
  maxOrdens 
}: OrdemPerfiladeiraFormProps) {
  console.log('OrdemPerfiladeiraForm rendered with maxOrdens:', maxOrdens);
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Criar Ordens de Perfiladeira</CardTitle>
