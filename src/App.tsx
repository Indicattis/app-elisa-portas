            ...
            <BrowserRouter>
              <Routes>
                ...
                <Route
                  path="/dashboard"
                  element={
                    <ProtectedRouteWithPermission permission="dashboard">
                      <DashboardLayout>
                        <Dashboard />
                      </DashboardLayout>
                ...
                <Route
                  ...
                  element={
                    <ProtectedRouteWithPermission permission="leads">
                      <DashboardLayout>
                        <Leads />
                      </DashboardLayout>
                    </ProtectedRouteWithPermission>
                ...
                <Route
                  ...
                  element={
                    <ProtectedRouteWithPermission permission="orcamentos">
                      <DashboardLayout>
                        <Orcamentos />
                      </DashboardLayout>
                    </ProtectedRouteWithPermission>
                ...
                <Route
                  ...
                  element={
                    <ProtectedRouteWithPermission permission="faturamento">
                      <DashboardLayout>
                        <Faturamento />
                      </DashboardLayout>
                    </ProtectedRouteWithPermission>
                ...
                <Route
                  ...
                  element={
                    <ProtectedRouteWithPermission permission="visitas">
                      <DashboardLayout>
                        <Visitas />
                      </DashboardLayout>
                    </ProtectedRouteWithPermission>
                ...
                <Route
                  ...
                  element={
                    <ProtectedRouteWithPermission permission="producao">
                      <DashboardLayout>
                        <Producao />
                      </DashboardLayout>
                    </ProtectedRouteWithPermission>
                ...
                <Route
                  ...
                  element={
                    <ProtectedRouteWithPermission permission="marketing">
                      <DashboardLayout>
                        <Marketing />
                      </DashboardLayout>
                    </ProtectedRouteWithPermission>
                ...
                <Route
                  ...
                  element={
                    <ProtectedRouteWithPermission permission="contas_receber">
                      <DashboardLayout>
                        <ContasReceber />
                      </DashboardLayout>
                    </ProtectedRouteWithPermission>
                ...
                <Route
                  ...
                  element={
                    <ProtectedRouteWithPermission permission="organograma">
                      <DashboardLayout>
                        <Organograma />
                      </DashboardLayout>
                    </ProtectedRouteWithPermission>
                ...
                <Route
                  ...
                  element={
                    <ProtectedRouteWithPermission permission="calendario">
                      <DashboardLayout>
                        <Calendario />
                      </DashboardLayout>
                    </ProtectedRouteWithPermission>
                ...
                <Route
                  ...
                  element={
                    <ProtectedRouteWithPermission permission="users">
                      <DashboardLayout>
                        <Autorizados />
                      </DashboardLayout>
                    </ProtectedRouteWithPermission>
                ...
                <Route
                  ...
                  element={
                    <ProtectedRouteWithPermission permission="vendas">
                      <DashboardLayout>
                        <Pedidos />
                      </DashboardLayout>
                    </ProtectedRouteWithPermission>
                ...
                <Route
                  ...
                  element={
                    <ProtectedRouteWithPermission permission="contador_vendas">
                      <DashboardLayout>
                        <ContadorVendas />
                      </DashboardLayout>
                    </ProtectedRouteWithPermission>
