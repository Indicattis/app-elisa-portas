                    ...
                    <Table className="text-xs">
                      <TableHeader>
                        <TableRow className="border-primary/10 hover:bg-primary/5">
                          ...
                          <TableHead className="text-xs text-white/70">Última Troca Óleo</TableHead>
                          ...
                          <TableHead className="text-xs text-white/70">Última Conferência</TableHead>
                            ...
                            >
                              ...
                              <TableCell>
                                {veiculo.ultima_conferencia_data 
                                  ...
                                  : <span className="text-white/50">Nunca</span>
                                }
                              </TableCell>
