...
import { Package, RefreshCw, Wrench, HardHat, AlertTriangle, UserPlus } from "lucide-react";
...
export default function ControleLogistica() {
  ...
  return (
    <MinimalistLayout 
      title="Controle de Logística" 
      subtitle="Acompanhe pedidos na logística"
      backPath="/logistica"
      breadcrumbItems={[
