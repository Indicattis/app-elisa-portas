  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0">
        {/* Nebulosa de fundo */}
        <div className="absolute inset-0 bg-gradient-radial from-purple-500/10 via-blue-500/5 to-transparent" />
        ...
        {Array.from({ length: 20 }).map((_, i) => (
          <div
            key={`big-star-${i}`}
            className="absolute w-2 h-2 bg-gradient-to-r from-yellow-200 to-white rounded-full shadow-lg animate-pulse"
            style={{
              left: `${Math.random() * 100}%`,
              top: `${Math.random() * 100}%`,
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-6">
        <div className="text-center space-y-8">
          ...
          <div className="space-y-4">
            <h1 className="text-6xl md:text-8xl font-bold bg-gradient-to-r from-yellow-200 via-yellow-100 to-yellow-300 bg-clip-text text-transparent drop-shadow-2xl animate-fade-in">
              DASHBOARD
            </h1>
          ...
          <div className="relative group">
            {/* Glow effect */}
            <div className="absolute -inset-4 bg-gradient-to-r from-yellow-200 via-yellow-100 to-yellow-300 opacity-75 group-hover:opacity-100 transition duration-1000" />
            
            {/* Container principal */}
            <div className="relative bg-gradient-to-br from-yellow-800/90 via-yellow-700/90 to-yellow-800/90 backdrop-blur-xl border-2 border-yellow-200/50 p-12 md:p-16 shadow-2xl">
              {/* Padrão hexagonal de fundo */}
              <div className="absolute inset-0 opacity-5">
                <div className="w-full h-full bg-[radial-gradient(circle_at_50%_50%,rgba(255,235,59,0.2)_1px,transparent_1px)] bg-[length:40px_40px]" />
              </div>
              
              {/* Bordas internas brilhantes */}
              <div className="absolute inset-4 border border-yellow-200/30" />
              
              {/* Conteúdo */}
              <div className="relative space-y-6">
                <div className="text-lg md:text-xl text-yellow-100/80 font-medium tracking-wide uppercase">
                  Vendas do Mês
                </div>
                ...
                {loading ? (
                  <div className="space-y-4">
                    ...
                    <div className="text-yellow-100/60">Carregando...</div>
                  </div>
                ) : (
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-center gap-4">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-yellow-100/80 text-sm md:text-base">
              ...
              {/* Cantos decorativos */}
              <div className="absolute top-4 left-4 w-8 h-8 border-l-2 border-t-2 border-yellow-200/50" />
              <div className="absolute top-4 right-4 w-8 h-8 border-r-2 border-t-2 border-yellow-200/50" />
              <div className="absolute bottom-4 left-4 w-8 h-8 border-l-2 border-b-2 border-yellow-200/50" />
              <div className="absolute bottom-4 right-4 w-8 h-8 border-r-2 border-b-2 border-yellow-200/50" />
            </div>
          </div>
