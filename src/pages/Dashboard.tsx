...
export default function Dashboard() {
  ...
  return <div className="min-h-screen flex items-center justify-center p-6">
      ...
      <div className="bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 shadow-2xl px-12 py-8 w-full max-w-4xl flex items-center justify-between" style={{
      height: '120px'
    }}>
        
        
        <div className="text-right">
          {loading ? <div className="text-4xl font-bold text-yellow-900">
              Carregando...
            </div> : <div className="text-4xl font-bold text-yellow-900">
