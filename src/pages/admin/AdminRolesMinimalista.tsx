...
export default function AdminRolesMinimalista() {
  ...
  return (
    <MinimalistLayout
      title="Cargos"
      subtitle="Gerenciar cargos do sistema"
      backPath="/admin"
      headerActions={
        <Button
      ...
      <div className="space-y-4">
        ...
        <div className="bg-primary/5 border border-primary/10 backdrop-blur-xl rounded-lg overflow-hidden">
          <div className="p-4 border-b border-primary/10">
            <h3 className="text-lg font-semibold text-white">Cargos do Sistema</h3>
            <p className="text-sm text-white/60">
              Lista completa de cargos e número de usuários ativos
            </p>
          </div>
