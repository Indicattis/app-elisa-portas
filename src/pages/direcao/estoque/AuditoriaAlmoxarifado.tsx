...
function ConferenciaCard({ conferencia }: ConferenciaCardProps) {
  ...
  const { data: itens = [], isLoading: loadingItens } = useQuery({
    queryKey: ["itens-conferencia-auditoria-almoxarifado", conferencia.id],
    queryFn: async () => {
...
export default function AuditoriaAlmoxarifado() {
  const { data: conferenciasConcluidas = [], isLoading } = useQuery({
    queryKey: ["conferencias-concluidas-almoxarifado"],
    queryFn: async () => {
  ...
  const breadcrumbItems = [
    ...
    { label: 'Auditoria Almoxarifado' }
  ];

  return (
    <MinimalistLayout
      title="Auditoria Almoxarifado"
      subtitle="Histórico de conferências do almoxarifado"
