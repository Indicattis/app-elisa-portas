...
import { Plus, ClipboardCheck, Building2, Car } from "lucide-react";
...
export default function FrotaDirecao() {
  ...
  const headerActions = (
    <>
      <Button
        size="sm"
        onClick={() => navigate('/direcao/frota/conferencia')}
      ...
      <Button
        size="sm"
        onClick={() => navigate('/direcao/frota/novo')}
