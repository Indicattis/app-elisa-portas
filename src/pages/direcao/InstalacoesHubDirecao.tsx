...
const menuItems = [
  {
    ...
    icon: HardHat,
    path: "/direcao/gestao-instalacao/instalacoes/ordens-instalacoes",
  },
  {
    label: "Gestão de Equipes",
    icon: Users,
    path: "/direcao/gestao-instalacao/instalacoes/equipes",
  },
  {
    label: "Cronograma",
    icon: CalendarDays,
    path: "/direcao/gestao-instalacao/instalacoes/cronograma",
  },
  {
    label: "Ranking Equipes",
    icon: Trophy,
    path: "/direcao/gestao-instalacao/instalacoes/ranking",
  },
];

export default function InstalacoesHubDirecao() {
