...
import { Target, Flame, Ruler, Package, CheckCircle, Paintbrush, Truck, User, Trophy } from "lucide-react";
...
export default function MetasDirecao() {
  ...
  const { data: usersComMetas } = useQuery({
    queryKey: ["users-com-metas-individuais-direcao"],
    queryFn: async () => {
