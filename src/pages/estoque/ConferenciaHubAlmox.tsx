...
import { useConferenciaAlmoxarifado } from "@/hooks/useConferenciaAlmoxarifado";
...
interface ConferenciaHubAlmoxProps {
  returnPath?: string;
  executionBasePath?: string;
}

export default function ConferenciaHubAlmox({ 
  returnPath = "/estoque", 
  executionBasePath = "/estoque/conferencia-almox" 
}: ConferenciaHubAlmoxProps) {
      ...
      <div className="sticky top-0 z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-semibold">Conferência do Almoxarifado</h1>
              <p className="text-sm text-muted-foreground">
                Gerencie e execute conferências do almoxarifado
              </p>
            </div>
          </div>
        </div>
