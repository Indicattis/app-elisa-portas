...
import { Plus, Pencil, Trash2, Search, Coins, Layers, Settings2, ArrowLeft } from "lucide-react";
      ...
      <div className="container mx-auto p-6 pt-20 space-y-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex gap-2">
            <Button 
              variant="outline" 
              onClick={() => setCategoriasManagerDialog(true)}
            ...
            <Button 
              onClick={() => setTipoCustoDialog(true)}
                        ...
                        <TableCell className="text-right">
                          <div className="flex justify-end gap-1">
                            <Button 
                              variant="ghost" 
                              size="sm" 
                              onClick={() => handleEditTipoCusto(tipo)}
                            ...
                            <Button 
                              variant="ghost" 
                              size="sm" 
                              onClick={() => setDeleteDialog({ type: "tipo", id: tipo.id })}
      ...
      <Dialog open={tipoCustoDialog} onOpenChange={(open) => {
        ...
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Preencha os dados do tipo de custo
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-2">
                ...
                <Select 
                  ...
                  onValueChange={(v) => setTipoCustoForm({ ...tipoCustoForm, categoria_id: v, subcategoria_id: "" })}
                >
                  <SelectTrigger>
              ...
              <div className="grid gap-2">
                ...
                <Select 
                  ...
                  onValueChange={(v) => setTipoCustoForm({ ...tipoCustoForm, subcategoria_id: v })}
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="grid gap-2">
                ...
                <Select 
                  ...
                  onValueChange={(v: 'fixa' | 'variavel') => setTipoCustoForm({ ...tipoCustoForm, tipo: v })}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <Select 
                ...
                onValueChange={(v) => setSubcategoriaForm({ ...subcategoriaForm, categoria_id: v })}
              >
                <SelectTrigger>
                  <SelectValue placeholder="Selecione" />
                </SelectTrigger>
